...
export const exercises: Exercise[] = [
  ...
  ex('238', 'Dead Bug', ['Core', 'Warm-up']),
  ex('239', 'Bird Dog', ['Core', 'Warm-up', 'Back', 'Glutes']),
  ex('240', 'Plank', ['Core', 'Warm-up']),
  ex('241', 'Side Plank', ['Core', 'Warm-up']),
  ex('242', 'Hollow Hold', ['Core', 'Warm-up']),
